...
namespace MyEshop.Areas.Admin.Controllers
{
    public class SlidersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "SlideID,Title,ImageName,StartDate,EndDate,IsActive,Link")] Slider slider,HttpPostedFileBase imgUp)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "SlideID,Title,ImageName,StartDate,EndDate,IsActive,Link")] Slider slider,HttpPostedFileBase imgUp)
        {
            if (ModelState.IsValid)
            {
                if (imgUp != null)
